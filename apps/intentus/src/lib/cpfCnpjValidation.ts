/**
 * Validates CPF digit check (Brazilian individual tax ID)
 */
...
/**
 * Validates CNPJ digit check (Brazilian company tax ID)
 */
...
/**
 * Validates either CPF or CNPJ based on digit count
 */
...
/**
 * Formats CPF or CNPJ with mask as user types
 */
