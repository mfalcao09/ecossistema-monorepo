...
| ----- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------- |
| P-130 | Decisão técnica | **Definir provedor LLM para DS Agente** — implementado hoje com `openai` npm (GPT-4o-mini + embeddings), mas provedor não está decidido. Avaliar: OpenAI, Anthropic Claude, Groq, local. Interface isolada em `openai-client.ts` (trocar = reescrever só esse arquivo). Configurar API key do provedor escolhido. | Marcelo      | Bloqueia tudo LLM/embedding     |
