...
import {
  ...
  Eye, ChevronRight, AlertCircle, RefreshCw, User,
} from "lucide-react";
          ...
          {resultados.map((diploma) => (
            <div key={diploma.id} className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <a
                  href={`/diploma/processos/preview-historico?nome=${encodeURIComponent(diploma.diplomado_nome)}&cpf=${encodeURIComponent(diploma.diplomado_cpf)}`}
                  target="_blank"
