...
import { verificarAuthComPermissao, erroBadRequest, erroNaoEncontrado, erroInterno } from '@/lib/security/api-guard'
import { validarCSRF } from '@/lib/security/csrf'
import { obterMapaPermissoes, atualizarPermissoesPapel, buscarPapel } from '@/lib/supabase/rbac'
