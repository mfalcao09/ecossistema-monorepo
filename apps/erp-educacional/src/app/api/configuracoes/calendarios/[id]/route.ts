...
export async function PUT(
  ...
  try {
    ...
    if (body.visivel_portal !== undefined) input.visivel_portal = body.visivel_portal
    if (body.ano_letivo_id !== undefined) input.ano_letivo_id = body.ano_letivo_id
    if (body.periodo_letivo_id !== undefined) input.periodo_letivo_id = body.periodo_letivo_id
