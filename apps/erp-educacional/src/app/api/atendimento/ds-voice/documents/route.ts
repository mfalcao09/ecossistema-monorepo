...
import { documentCreateSchema } from "@/lib/atendimento/ds-voice-schemas";
...
export const GET = withPermission(
  ...
  let qb = ctx.supabase
    .from("ds_voice_documents")
    .select(
      "id, folder_id, title, storage_path, file_url, file_size_bytes, mime_type, filename, enabled, created_at",
    )
