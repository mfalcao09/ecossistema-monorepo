...
export const GET = protegerRota(async (request: NextRequest, { userId, tenantId }) => {
  ...
  try {
    ...
    if (nome) {
      ...
      return NextResponse.json({
        source: "sugestao_ia",
        message: "Dados sugeridos pela IA com base no nome do curso. Confira e ajuste.",
        ...sugestoes,
      });
    }
    ...
    return NextResponse.json({
      source: "manual",
      message: "Não foi possível buscar automaticamente. Preencha manualmente.",
    });
  } catch (err) {
...
function mapearGrau(grau?: string): string {
  ...
  if (g.includes("licenciatura") || g.includes("licenciado")) return "licenciado";
...
function gerarSugestoesCurso(nome: string) {
  ...
  const cursoMap: Record<string, { grau: string; titulo: string; ch: number }> = {
    "administra": { grau: "bacharel", titulo: "Bacharel em Administração", ch: 3000 },
    "direito": { grau: "bacharel", titulo: "Bacharel em Direito", ch: 3700 },
    "contab": { grau: "bacharel", titulo: "Bacharel em Ciências Contábeis", ch: 3000 },
    "ciências contábeis": { grau: "bacharel", titulo: "Bacharel em Ciências Contábeis", ch: 3000 },
    "pedagogia": { grau: "licenciado", titulo: "Licenciado em Pedagogia", ch: 3200 },
    "letras": { grau: "licenciado", titulo: "Licenciado em Letras", ch: 2800 },
    "educação física": { grau: "bacharel", titulo: "Bacharel em Educação Física", ch: 3200 },
    "enfermagem": { grau: "bacharel", titulo: "Bacharel em Enfermagem", ch: 4000 },
    "psicologia": { grau: "bacharel", titulo: "Bacharel em Psicologia", ch: 4000 },
    "engenharia": { grau: "bacharel", titulo: "Bacharel em Engenharia", ch: 3600 },
    "sistemas": { grau: "bacharel", titulo: "Bacharel em Sistemas de Informação", ch: 3000 },
    "gestão": { grau: "tecnologo", titulo: "Tecnólogo em Gestão", ch: 1600 },
    "agronomia": { grau: "bacharel", titulo: "Bacharel em Agronomia", ch: 3600 },
    "serviço social": { grau: "bacharel", titulo: "Bacharel em Serviço Social", ch: 3000 },
    "matemática": { grau: "licenciado", titulo: "Licenciado em Matemática", ch: 3200 },
    "história": { grau: "licenciado", titulo: "Licenciado em História", ch: 2800 },
    "geografia": { grau: "licenciado", titulo: "Licenciado em Geografia", ch: 2800 },
    "biologia": { grau: "licenciado", titulo: "Licenciado em Ciências Biológicas", ch: 3200 },
  };
