...
const TEMPLATES = {
  saude: {
    colunas: [
      { campo: 'codigo', label: 'Código', visivel: true, ordem: 1, largura: 80 },
      { campo: 'nome', label: 'Disciplina', visivel: true, ordem: 2, largura: 250 },
      { campo: 'periodo', label: 'Período', visivel: true, ordem: 3, largura: 70 },
      { campo: 'carga_horaria_aula', label: 'C.H. Aula', visivel: true, ordem: 4, largura: 80 },
      { campo: 'carga_horaria_relogio', label: 'C.H. Relógio', visivel: true, ordem: 5, largura: 80 },
      { campo: 'nota', label: 'Nota', visivel: true, ordem: 6, largura: 60 },
      { campo: 'conceito_especifico', label: 'Conceito', visivel: true, ordem: 7, largura: 80 },
      { campo: 'situacao', label: 'Situação', visivel: true, ordem: 8, largura: 100 },
  ...
  exatas: {
    colunas: [
      ...
      { campo: 'nome', label: 'Disciplina', visivel: true, ordem: 2, largura: 250 },
      { campo: 'periodo', label: 'Período', visivel: true, ordem: 3, largura: 70 },
      { campo: 'carga_horaria_aula', label: 'Aula', visivel: true, ordem: 4, largura: 60 },
      { campo: 'carga_horaria_relogio', label: 'Prática', visivel: true, ordem: 5, largura: 60 },
      { campo: 'nota', label: 'Nota', visivel: true, ordem: 6, largura: 60 },
      { campo: 'situacao', label: 'Situação', visivel: true, ordem: 7, largura: 100 },
      { campo: 'forma_integralizacao', label: 'Forma Integr.', visivel: true, ordem: 8, largura: 120 },
    ] as HistoricoColunaConfig[],
    secoes: {
  ...
  licenciatura: {
    colunas: [
      { campo: 'codigo', label: 'Código', visivel: true, ordem: 1, largura: 80 },
      { campo: 'nome', label: 'Componente Curricular', visivel: true, ordem: 2, largura: 300 },
      { campo: 'periodo', label: 'Per.', visivel: true, ordem: 3, largura: 50 },
      { campo: 'carga_horaria_aula', label: 'Horas', visivel: true, ordem: 4, largura: 70 },
      { campo: 'nota', label: 'Conceito', visivel: true, ordem: 5, largura: 70 },
      { campo: 'situacao', label: 'Situação', visivel: true, ordem: 6, largura: 100 },
      { campo: 'docente_nome', label: 'Docente', visivel: true, ordem: 7, largura: 200 },
    ] as HistoricoColunaConfig[],
    secoes: {
      agrupar_por: 'periodo' as const,
  ...
  tecnologo: {
    colunas: [
      { campo: 'codigo', label: 'Código', visivel: true, ordem: 1, largura: 70 },
      { campo: 'nome', label: 'Módulo', visivel: true, ordem: 2, largura: 280 },
      { campo: 'carga_horaria_aula', label: 'Horas', visivel: true, ordem: 3, largura: 70 },
      { campo: 'nota', label: 'Nota', visivel: true, ordem: 4, largura: 60 },
      { campo: 'situacao', label: 'Situação', visivel: true, ordem: 5, largura: 100 },
    ] as HistoricoColunaConfig[],
    secoes: {
  ...
  humanas: {
    colunas: [
      { campo: 'codigo', label: 'Código', visivel: true, ordem: 1, largura: 80 },
      { campo: 'nome', label: 'Disciplina', visivel: true, ordem: 2, largura: 280 },
      { campo: 'periodo', label: 'Sem.', visivel: true, ordem: 3, largura: 50 },
      { campo: 'carga_horaria_aula', label: 'C.H.', visivel: true, ordem: 4, largura: 60 },
...
export const POST = protegerRota(
  async (request: NextRequest) => {
    try {
      ...
      let formatacaoRegras: HistoricoFormatacaoRegra[] = [...selectedTemplate.formatacao]
