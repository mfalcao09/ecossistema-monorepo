...
export default function TermoResponsabilidadeTemplate({
  ...
  const dataEmissao =
    dados.data_emissao ?? new Date().toISOString().split("T")[0];
        ...
        >
          ...
          >
            <p className="mb-5">
              ...
              {dados.ies_cnpj ? (
                <>
                  ...
                  <strong>{formatarCNPJ(dados.ies_cnpj)}</strong>,
                </>
              ) : (
                ","
              )}{" "}
              ...
              , neste ato representada por seu(a){" "}
              <strong>{dados.responsavel_cargo}</strong>,{" "}
              ...
              , vem formalmente{" "}
              <strong>DECLARAR E ASSUMIR TOTAL RESPONSABILIDADE</strong> pelo
              seguinte:
            </p>

            <p className="mb-4">
              <strong>I —</strong> Os dados cadastrais, acadêmicos e documentais
              consolidados no processo de emissão do presente Diploma Digital
              foram extraídos, validados e confirmados a partir do acervo físico
              e digital desta Instituição, sob responsabilidade exclusiva da
              mesma, nos termos do art. 11 da Portaria MEC nº 70/2025.
            </p>

            <p className="mb-4">
              <strong>II —</strong> Os XMLs oficiais
              (DocumentacaoAcademicaRegistro, HistoricoEscolarDigital e
              DiplomaDigital), bem como os PDFs complementares (Histórico
              Escolar e Termo de Expedição), foram gerados a partir de um{" "}
              <em>snapshot imutável</em> dos dados revisados, garantindo
              integridade e rastreabilidade desde a extração inicial até a
              assinatura digital final.
            </p>

            <p className="mb-4">
              <strong>III —</strong> A autenticidade e a integridade deste
              documento poderão ser verificadas a qualquer tempo por meio dos
              mecanismos de assinatura digital ICP-Brasil aplicados, em
              conformidade com a MP nº 2.200-2/2001 e com o XSD v1.05 do MEC.
            </p>
            ...
            <p className="mb-4">
              ...
              para auditorias do MEC/INEP, nos termos da IN SESu/MEC nº 05/2022
            ...
            <p className="mb-4">
              ...
              responsabilidade desta Instituição, que se compromete a
              corrigi-las conforme os ritos previstos na Portaria MEC nº
              70/2025, preservando a segurança jurídica do(a) diplomado(a).
            </p>
          </div>
