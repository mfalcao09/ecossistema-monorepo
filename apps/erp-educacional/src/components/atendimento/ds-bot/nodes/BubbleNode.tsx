...
export default function BubbleNode({
  ...
  return (
    <div
      className={`rounded-lg border-2 bg-white shadow-sm min-w-[200px] max-w-[280px] ${selected ? "border-blue-500" : "border-gray-200"}`}
    >
      ...
      <div className="px-3 py-2 text-sm text-gray-800 break-words">
        {t === "bubble_text"
          ? d.text || <em className="text-gray-400">sem texto</em>
          : null}
