...
// Helpers
// ──────────────────────────────────────────────────────────────
function n<T extends DsBotNode>(node: T): T {
  return node;
}
function e(
  id: string,
...
const qualificacaoMatricula: BotTemplate = {
  ...
  description:
    "Coleta nome, CPF e curso de interesse antes de encaminhar ao humano.",
  channels: ["whatsapp"],
  ...
  flow: {
    ...
    nodes: [
      ...
      n({
        ...
        position: { x: 220, y: 0 },
        data: {
          text: "Olá! Sou o assistente da FIC. Para te ajudar com matrícula, preciso de alguns dados.",
        },
      }),
      n({
        id: "ask-name",
      ...
      n({
        ...
        position: { x: 660, y: 0 },
        data: {
          question: "Informe seu CPF (só números)",
          variable: "cpf",
          required: true,
          min_length: 11,
          max_length: 14,
      ...
      n({
        id: "transfer",
        type: "attendance_transfer_queue",
        category: "attendance",
        position: { x: 1320, y: 0 },
        data: {
          queue_id: "queue:matriculas",
          note: "Lead qualificado por DS Bot",
        },
      }),
      n({
        id: "msg-bye",
        ...
        position: { x: 1540, y: 0 },
        data: {
          text: "Obrigado, {{nome}}! Um consultor de matrícula vai falar com você em instantes.",
        },
      }),
      n({
        id: "end",
...
const agendamentoVisita: BotTemplate = {
  ...
  description:
    "Coleta preferência de data e encaminha para a equipe de recepção.",
  channels: ["whatsapp"],
  trigger_type: "keyword",
  ...
  flow: {
    ...
    nodes: [
      ...
      n({
        ...
        category: "bubble",
        position: { x: 220, y: 0 },
        data: { text: "Agendamento de visita — FIC. Vamos começar!" },
      }),
      n({
        id: "name",
        type: "input_text",
        category: "input",
        position: { x: 440, y: 0 },
        data: { question: "Seu nome?", variable: "nome", required: true },
      }),
      n({
        id: "date",
        type: "input_date",
        ...
        position: { x: 660, y: 0 },
        data: {
          question: "Qual data você prefere?",
          variable: "data_visita",
          required: true,
        },
      }),
      n({
        ...
        category: "contact",
        position: { x: 880, y: 0 },
        data: { tag: "visita-agendada" },
      }),
      n({
        id: "protocol",
        type: "attendance_open_protocol",
        category: "attendance",
        position: { x: 1100, y: 0 },
        data: {
          subject: "Agendamento de visita — {{nome}} em {{data_visita}}",
          priority: "normal",
        },
      }),
      n({
        ...
        position: { x: 1320, y: 0 },
        data: {
          text: "Recebi seu pedido! Em breve vamos confirmar o agendamento.",
        },
      }),
      n({
        id: "end",
  ...
  flow: {
    ...
    nodes: [
      ...
      n({
        ...
        position: { x: 220, y: 0 },
        data: {
          text: "Para continuar, você autoriza o uso dos seus dados para contato e atendimento, conforme Política de Privacidade FIC?",
        },
      }),
      n({
        id: "ask",
      ...
      n({
        ...
        data: {
          text: "Obrigado! Em instantes um atendente vai falar com você.",
        },
      }),
      n({
        id: "transfer",
      ...
      n({
        ...
        position: { x: 880, y: 120 },
        data: {
          text: "Entendido. Se mudar de ideia, é só escrever novamente. Até mais!",
        },
      }),
      n({
        id: "end-no",
  ...
  flow: {
    ...
    nodes: [
      ...
      n({
        ...
        position: { x: 220, y: 0 },
        data: {
          text: "Vou te ajudar com envio de documentos. Por favor, envie:",
        },
      }),
      n({
        id: "rg",
      ...
      n({
        ...
        position: { x: 660, y: 0 },
        data: {
          question: "Envie CPF (foto ou PDF)",
          variable: "cpf_url",
          required: true,
          accept: "image/*,application/pdf",
          max_mb: 10,
      ...
      n({
        ...
        position: { x: 1100, y: 0 },
        data: {
          subject: "Documentos recebidos — {{contact.name}}",
          priority: "normal",
        },
      }),
      n({
        ...
        position: { x: 1320, y: 0 },
        data: {
          text: "Documentos recebidos! A secretaria vai validar em até 2 dias úteis.",
        },
      }),
      n({
        id: "end",
  ...
  flow: {
    ...
    nodes: [
      ...
      n({
        ...
        position: { x: 220, y: 0 },
        data: {
          text: "Oi {{nome}}! Gostaríamos de saber sua opinião sobre o atendimento.",
        },
      }),
      n({
        id: "nps",
        ...
        position: { x: 440, y: 0 },
        data: {
          question: "De 0 a 10, o quanto você recomendaria a FIC?",
          variable: "nps",
          min: 0,
          max: 10,
          required: true,
      ...
      n({
        ...
        category: "bubble",
        position: { x: 1100, y: -120 },
        data: { text: "Que ótimo! 🎉 Obrigado por ser um aluno FIC." },
      }),
      n({
        id: "detractor",
        type: "contact_add_tag",
      ...
      n({
        ...
        position: { x: 1100, y: 120 },
        data: {
          question: "Poderia nos contar o que podemos melhorar?",
          variable: "nps_feedback",
        },
      }),
      n({
        id: "thanks-d",
        ...
        category: "bubble",
        position: { x: 1320, y: 120 },
        data: { text: "Obrigado pelo feedback! Vamos trabalhar nisso." },
      }),
      n({
        id: "proto",
        type: "attendance_open_protocol",
        category: "attendance",
        position: { x: 1540, y: 120 },
        data: { subject: "NPS {{nps}} — {{nome}}", priority: "high" },
      }),
      n({
        id: "end",
        type: "flow_end",
